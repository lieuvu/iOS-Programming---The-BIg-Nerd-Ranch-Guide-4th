...
- (IBAction)takePicture:(id)sender
{
    ...
    CGPoint center;
    center.x = screenRect.origin.x + screenRect.size.width / 2.0;
    center.y = screenRect.origin.y + screenRect.size.height / 2.0;
    CGSize size;
    size.width = screenRect.size.width * 0.2;
    size.height = screenRect.size.height * 0.2;
    CGRect overlayRect = CGRectMake(center.x - size.width/2, center.y - size.height/2, size.width, size.height);
...
{
    // Delete the image in the BNRImageStore store
