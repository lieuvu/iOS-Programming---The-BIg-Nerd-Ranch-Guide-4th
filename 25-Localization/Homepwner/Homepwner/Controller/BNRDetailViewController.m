...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.assetTypeButton.title = [NSString stringWithFormat:NSLocalizedString(@"Type: %@", @"Asset type button"), NSLocalizedString(typeLabel, nil)];
